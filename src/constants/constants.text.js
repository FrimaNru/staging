...
export const dataCharacteristic = [
    { title: 'ДОСТАВКА, ОПЛАТА И ВОЗВРАТ', text: 'Доставка – курьерской службой СДЭК до пункта выдачи заказов.<br />Оплата – безналичный расчет при оформлении заказа.<br />Возврат – в течение 14 дней.' },
    { title: 'ГАРАНТИЯ И УХОД', text: 'Обеспечьте для своего нового украшения сухое чистое место хранения, лучше исключить соседство с другой бижутерией, чтобы не образовалось царапин. Избегайте посещения бань, саун и пляжей, а также попадания химии на поверхность изделия. Загрязнения легко убрать мягкой влажной тканью и при необходимости шампунем, после чего насухо вытереть.<br />При правильном хранении и уходе наши украшения будут радовать вас своим неизменно превосходным видом долгие годы.' }
];

// Текст для страницы "О бренде" (взят из таба "Материал" до слова "элегантными")
export const brandMaterialText =
    'Наши украшения созданы из уникального сплава Zamak и покрыты гальваническим методом для большей прочности и износостойкости. <br />' +
    'Zamak - это идеальный материал для изготовления премиальной бижутерии, потому что в первую очередь он является гипоаллергенным, так как не содержит никеля, который и  является основным источником аллергии людей. Состав сплава zamak: цинк, магний, алюминий, медь. <br />' +
    'Также физические и механические свойства сплавов Zamak позволяют изготавливать изделия с точностью до одной сотой миллиметра, но при этом они очень твердые и прочные, не боятся больших нагрузок. <br />' +
    'Гальваническое покрытие обеспечивает изделиям устойчивость к истиранию и коррозии, придает украшениям еще более привлекательный внешний вид, добавляя блеска, делая  элегантными.';
