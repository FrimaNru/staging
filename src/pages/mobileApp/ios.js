...
export default function IosPage() {
    return (
        <>
            <Head>
                <title>Мобильное приложение IOS – Mi Alegria</title>
                <meta name="description" content='Установи мобильное приложение на телефон (IOS) через свой браузер. Мы всегда готовы помочь вам в Mi Alegria!' />
