...
export default function Delivery() {
    return (
        <>
            <Head>
                <title>Контакты интернет-магазина премиальной бижутерии Mi Alegria</title>
                <meta name="description" content='Интернет-магазин Mi Alegria – Контактные данные ✔ Бижутерия премиум-класса ✔ Высокое качество, эксклюзивный дизайн ✔ Бесплатная доставка и гарантия на все ювелирные изделия.' />
