...
export default function SilverJewelryPage({ products, popularProducts }) {
    return (
        <>
            <Head>
                <title>Бижутерия под серебро – купить, цена в интернет-магазине в Mi Alegria</title>
                <meta name="description" content="Купить эксклюзивную бижутерию под серебро в Москве в интернет-магазине Mi Alegria ✔ Ювелирные изделия класса люкс, созданные дизайнерами Турции, Китая, Индии и Таиланда ✔ Закажите украшение на сайте с доставкой." />
            ...
            <center>
                <main>
                    <Header />
                    <Catalog initialPage={1} initialProducts={products} h1Title="БИЖУТЕРИЯ ПОД СЕРЕБРО" popularProducts={popularProducts} />
                    <Footer />
                </main>
            </center>
        </>
...
export async function getServerSideProps({ query }) {
    ...
    const products = await getFilteredProducts({
        subcategoryPath: '/bizhuteriya-pod-serebro',
        productType: null,
        color: 'silver',
        text,
        filter
