...
export default function KrupnyeKole({ products, popularProducts }) {
    return (
        <>
            <Head>
                <title>Крупная бижутерия на шею – купить, цена в интернет-магазине в Mi Alegria</title>
                <meta name="description" content="Купить большое колье на шею и другую премиальную бижутерию можно в интернет-магазине Mi Alegria – доставим в любой город ✔ Уникальная коллекция объемных колье для неповторимого образа ✔ Выберите свое украшение на сайте" />
                <meta name="keywords" content="большие колье, крупные колье, объемные колье, бижутерия, Mi Alegria" />
                <link rel="canonical" href="https://mi-alegria.shop/catalog/kole/krupnye" />
