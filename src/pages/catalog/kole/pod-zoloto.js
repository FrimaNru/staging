...
export default function PodZolotoKole({ products, popularProducts }) {
    return (
        <>
            <Head>
                <title>Колье под золото – купить в магазине элитной бижутерии Mi Alegria</title>
                <meta name="description" content="Дизайнерское колье под золото дополнит ваш образ и подарит ему непревзойденное чувство стиля и изысканность ✔ Заказать украшения можно на сайте интернет-магазине Mi Alegria – доставим в любой город." />
                <meta name="keywords" content="колье под золото, золотые колье, колье, бижутерия, Mi Alegria" />
                <link rel="canonical" href="https://mi-alegria.shop/catalog/kole/pod-zoloto" />
...
export async function getServerSideProps({ query }) {
    ...
    const products = await getFilteredProducts({
        subcategoryPath: '/kole/pod-zoloto',
