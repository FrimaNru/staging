...
export default function DlinnyeKole({ products, popularProducts }) {
    return (
        <>
            <Head>
                <title>Длинное ожерелье – купить в интернет-магазине в Mi Alegria</title>
                <meta name="description" content="Купить длинное колье на шею – цена в интернет-магазине элитной бижутерии Mi Alegria ✔ Изысканные украшения актуального дизайна для любого стиля и возраста ✔ Выберите свое длинное ожерелье и оформите заказ с доставкой на нашем сайте." />
                <meta name="keywords" content="длинные колье, длинные ожерелья, колье на шею, бижутерия, Mi Alegria" />
                <link rel="canonical" href="https://mi-alegria.shop/catalog/kole/dlinnye" />
