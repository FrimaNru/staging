...
export default function MnogoslojnyeKole({ products, popularProducts }) {
    return (
        <>
            <Head>
                <title>Многослойные колье из цепочек – купить, цена в интернет-магазине в Mi Alegria</title>
                <meta name="description" content="Колье из нескольких цепочек – купить в Москве в интернет-магазине Mi Alegria ✔ Элитная бижутерия премиум-класса для твоего уникального образа ✔ Шикарные многослойные ожерелья и другие украшения с доставкой." />
                <meta name="keywords" content="многослойные колье, колье из цепочек, многослойные ожерелья, бижутерия, Mi Alegria" />
                <link rel="canonical" href="https://mi-alegria.shop/catalog/kole/mnogoslojnye" />
...
export async function getServerSideProps({ query }) {
    ...
    const products = await getFilteredProducts({
        subcategoryPath: '/kole/mnogoslojnye',
