...
export default function BrandPage() {
    return (
        <>
            <Head>
                <title>О Бренде Mi Alegria – История и Ценности</title>
                <meta name="description" content='Узнайте больше о бренде Mi Alegria: наша история, миссия и ценности. Мы предлагаем только лучшие ювелирные изделия, созданные с любовью и мастерством.' />
