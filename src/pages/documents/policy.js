...
export default function PolicyPage() {
    return (
        <>
            <Head>
                <title>Политика конфиденциальности - Mi Alegria</title>
                <meta name="description" content='Узнайте, как Mi Alegria защищает вашу личную информацию. Наша политика конфиденциальности объясняет, какие данные мы собираем и как мы их используем для обеспечения безопасности ваших покупок.' />
