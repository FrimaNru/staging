...
export default function PolicyPage() {
    return (
        <>
            <Head>
                <title>Пользовательское соглашение - Mi Alegria</title>
                <meta name="description" content='Ознакомьтесь с пользовательским соглашением Mi Alegria. Узнайте о правилах и условиях использования наших услуг, а также о ваших правах и обязанностях при совершении покупок.' />
